...
(()=>{
 ...
 const P={
  ...
  jazz:{bpm:132,difficulty:'上級',meter:'4/4',feature:'スウィングするライド・レガートと2・4拍のハイハット',role:'ライドが「チーン・チキ」を作り、左足ハイハットが2・4拍、スネアとキックがコンピングする',practice:'まずライドとペダルハイハットだけでスウィングし、次にスネアとキックを小さく加える',lesson:'均等な8分音符ではなく、ライドの長短とコンピングの会話でジャズの揺れを感じよう。',pattern:{ride:[0,3,4,7,8,11,12,15],kick:[0,10],snare:[6,13],pedalHat:[4,12]}},
 ...
 Object.entries(groups).forEach(([type,names])=>names.forEach((name,i)=>{
  ...
  if(type==='jazz'){
   item.bpm=[116,150,188,176,142,168,126,120][i];
   item.swing=[28,34,38,32,30,36,40,26][i];
   const jazzPatterns=[
    {ride:[0,3,4,7,8,11,12,15],kick:[0,10],snare:[6,13],pedalHat:[4,12]},
    {ride:[0,3,4,7,8,11,12,15],kick:[2,9,14],snare:[5,11,15],pedalHat:[4,12]},
    {ride:[0,3,4,7,8,11,12,15],kick:[0,8],snare:[7,14],pedalHat:[4,12]},
    {ride:[0,3,4,7,8,11,12,15],kick:[0,6,10,14],snare:[4,12],pedalHat:[4,12],floorTom:[3,11]},
    {ride:[0,3,4,7,8,11,12,15],kick:[0,7,10],snare:[4,10,12],pedalHat:[4,12],crash:[0]},
    {ride:[0,3,4,7,8,11,12,15],kick:[0,8,14],snare:[4,6,12,15],pedalHat:[4,12],crash:[0,8]},
    {ride:[0,3,4,7,8,11,12,15],kick:[0,10],snare:[6,13],pedalHat:[4,12],closedHat:[3,7,11,15]},
    {ride:[0,3,4,7,8,11,12,15],kick:[2,10],snare:[5,13,15],pedalHat:[4,12]}
   ];
   item.pattern=jazzPatterns[i];
  }
